...
export const steps = [
  ...
  },
  {
    target: ".settings",
    title: "Settings",
    content: "Customize your EthUI experience by adjusting preferences, managing security options, and configuring application settings.",
    placement: 'top' as Placement,
  },
  {
    target: '[homepage-tour="actions-Account"]',
    title: "Account",
    content: "View your account details, transfer tokens, or add addresses to the blacklist.",
    placement: 'right' as Placement,
  },
  {
    target: '[homepage-tour="actions-Transactions"]',
    title: "Transactions",
    content: "Review all your transactions and access detailed information for each one.",
    placement: 'right' as Placement,
  },
  {
  ...
  },
  {
    ...
    content: "Access an overview of all your network connections and their detailed information.",
    placement: 'right' as Placement,
  },
];
